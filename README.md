...
See the [plan](docs/PLAN.md), [ADRs](docs/adr/README.md), [server setup and mission build instructions](deploy/dcs/README.md), and [JSON bridge guide](docs/BRIDGE.md). The next bridge work is to test a richer mission, reconnect and restart behavior, then integrate a small FoW service.
